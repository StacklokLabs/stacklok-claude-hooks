...
["Report a Vulnerability"](https://github.com/StacklokLabs/stacklok-claude-hooks/security/advisories/new)
tab.
...
- Create a new
  ...
  `https://github.com/StacklokLabs/stacklok-claude-hooks/security/advisories/new`
